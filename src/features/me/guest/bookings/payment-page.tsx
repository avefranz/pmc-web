            ...
            {method === "promptpay" && promptPayId && (
              <div className="px-6 py-4 flex flex-col items-center gap-3">
                ...
                <p className="text-xs text-gray-400 text-center max-w-[220px]">
                  Scan with any Thai banking app, then tap <strong className="text-gray-600">Confirm</strong> below
                </p>
              </div>
            )}
              ...
              <div className="bg-bg-card rounded-2xl shadow-card p-5">
                ...
                {pendingPayments.length > 0 && (
                  <button
                    ...
                    className="w-full bg-brand hover:bg-[var(--color-primary-hover)] active:scale-[0.99] text-white font-semibold rounded-xl py-4 text-base transition-all flex items-center justify-center gap-2 shadow-sm"
                  >
                    <Lock size={15} />
                    Pay securely
                  </button>
