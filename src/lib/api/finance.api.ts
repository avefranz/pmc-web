...
export const financeApi = {
  ...
  // When no assetId is given the backend may return a single object or a
  // single-element array (legacy shape). We take [0] intentionally — this
  // endpoint is the "portfolio aggregate" view, not a multi-asset listing.
